...
# import sys
#
# from pymod_lib import pymod_sequence_manipulation as pmsm
# from pymod_lib.pymod_gui import shared_components
#
# class Ramachandran_plot_options_window(shared_components.PyMod_tool_window):
#
...
#                 text=pmsm.one2three(aa)+" ("+str(aa_freq)+")",
