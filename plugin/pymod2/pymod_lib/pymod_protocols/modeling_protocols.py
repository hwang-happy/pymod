...
class MODELLER_homology_modeling(PyMod_protocol, Modeling_session):
    ...
    def _perform_modelization(self):
        ...
        for model_file_number, model in enumerate(a.outputs):
            ...
            pymod_model_name = str(self.get_model_number()+1)+"_"+self.modeller_target_name
            ...
            for chain_number, (element, modeling_cluster) in enumerate(zip(parsed_model_file.get_pymod_elements(), self.modeling_clusters_list)):
        ...
        current_modeling_session = Modeling_session_information(self.pymod.performed_modeling_count + 1, a)
        ...
        alignment_lenght = 0
        for mc in sorted(self.modeling_clusters_list, key = lambda mc: mc.block_index): # sakura!
...
class Modeling_session_information(Modeling_session):
    ...
    """
    def __init__(self, session_id, automodel_object):
